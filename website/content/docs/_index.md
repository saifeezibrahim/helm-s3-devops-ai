...
Amazon S3. See [this AWS guide](https://docs.aws.amazon.com/prescriptive-guidance/latest/patterns/REDACTED.html) to get a detailed example use case overview.
